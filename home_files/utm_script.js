...
function setCookie(param_name, value, exdays) {
    ...
    var c_value = escape(value) + ((exdays == null) ? "" : "; domain=www.blueprism.com; path=/; expires=" + exdate.toUTCString());
...
function ppcUrlCookiePart1() {
    ...
    var param_names = new Array(
        ...
        'ppcParent;utm_campaignparent',
        'ppcVertical;utm_vertical',
...
function ppcUrlCookiePart2() {
    ...
    var param_names = new Array(
        'ppcSource;pDUTMSourceBP',
        'ppcMedium;pDUTMMediumBP',
        'ppcCampaign;pDUTMCampaignBP',
        'ppcAdGroup;pDUTMAdGroupBP',
        'ppcKeyword;pDUTMTermBP',
        'ppcContent;pDUTMContentBP',
        'ppcParent;pDUTMCampaignParentBP',
        'ppcVertical;pDUTMVerticalBP',
